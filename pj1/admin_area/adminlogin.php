...
<div class="text-center">
    <input type="submit" value="Login" class="bg-danger py-2  px-3 border-0" name="admin_login">
    <p> Want to go to website <a href="../index.php"  class="text-danger">Home</a></p>
</div>
</form>
</div>
</div>
...
if(isset($_POST['admin_login']))
{
    ...
    $select_query="Select * from admin where admin_name='$user_username'";
